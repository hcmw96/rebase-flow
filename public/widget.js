var RebaseServicesWidget = function(exports) {
...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  function WidgetProvider({ config, children }) {
    const [session, setSessionState] = reactExports.useState(() => {
      try {
    ...
    const setSession = reactExports.useCallback((newSession) => {
    ...
    const login = reactExports.useCallback(() => {
      ...
      const handleMessage = (event) => {
        var _a;
        if (((_a = event.data) == null ? void 0 : _a.type) === "rebase-oauth-callback") {
  ...
  function ServiceChip({ service, hideImage = false, listMode = false, onSelect }) {
    const getPrice = () => {
      const prices = service.variants.map((v2) => v2.price).filter((p2) => p2 !== null && p2 > 0);
      if (prices.length === 0) return null;
      return Math.min(...prices);
    };
    const getDuration = () => {
      const durations = service.variants.map((v2) => v2.duration).filter((d) => d !== null);
    ...
    if (listMode) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-0.5 min-w-0 flex-1 mr-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-[hsl(35,15%,88%)] text-left", children: service.baseName }),
              hasMultipleVariants && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-[hsl(35,8%,45%)]", children: [
                service.variants.length,
                " options"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
              duration && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-[hsl(35,8%,55%)] flex items-center gap-1", children: [
              ...
              price && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-[hsl(35,15%,75%)]", children: [
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          !hideImage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-square rounded-xl overflow-hidden bg-[hsl(25,12%,15%)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: service.image,
          ...
          hideImage && price && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-[hsl(35,8%,55%)]", children: [
            "from £",
            price
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-[hsl(35,15%,88%)] mt-2 line-clamp-2 leading-tight", children: service.baseName }),
          duration && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-[hsl(35,8%,55%)] mt-0.5 flex items-center gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "h-2.5 w-2.5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "12 6 12 12 16 14" })
            ] }),
            duration,
  ...
  const techTherapies = /* @__PURE__ */ new Set([
  ...
  function CategorySection({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-[hsl(25,10%,20%)]/50 last:border-b-0", children: [
        ...
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-[hsl(35,15%,88%)]", children: category }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-[hsl(35,8%,55%)] bg-[hsl(25,10%,15%)] px-2 py-0.5 rounded-full", children: services.length })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "h-5 w-5 text-[hsl(35,8%,55%)]", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "6 9 12 15 18 9" }) })
              }
            )
          ]
        }
      ...
      isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: isNonImageCategory ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 px-1", children: services.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ServiceChip,
            {
              service,
              listMode: true,
            ...
            service.baseName
          )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 px-1", children: services.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ServiceChip,
            {
              service,
  ...
  const hiddenGroupNames = /* @__PURE__ */ new Set([
    "Rebase Packages",
    "Corporate Credits",
    "Corporate credits",
    "Classes",
  ...
  const hiddenProgramIds = /* @__PURE__ */ new Set([12]);
  const hiddenServiceNames = /* @__PURE__ */ new Set([
    ...
    "Indian Head Massage",
    "Indian Massage",
    "Hyaluronic Acid - 1 Joint",
    "Hyaluronic Acid - 2 Joints",
    "Hyaluronic Acid - 3 Joints",
    "Hyaluronic Acid - 4 Joints",
    "Hyalouronic Acid - 1 Joint",
    "Hyalouronic Acid - 2 Joints",
    "Hyalouronic Acid - 3 Joints",
    "Hyalouronic Acid - 4 Joints"
  ]);
  const hiddenServiceNamePatterns = [
    /\bcorporate\b/i,
    /indian\s*head/i,
    /destress.*(head|neck|shoulder)/i
  ];
  function isHiddenServiceName(name) {
    const trimmed = name.trim();
    if (hiddenServiceNames.has(name) || hiddenServiceNames.has(trimmed)) return true;
    return hiddenServiceNamePatterns.some((re2) => re2.test(trimmed));
  }
  const programNameOverrides = {
  ...
  const serviceOrderWithinCategory = {
  ...
  const contactOnlyGroups = /* @__PURE__ */ new Set(["Osteopathy"]);
  ...
  const resolveGroupDescription = (current, baseName) => {
    if (!isPlaceholderDescription(current)) return current;
  ...
  const resolveVariantDescription = (variantName, groupName, mindbodyDesc) => {
    if (!isPlaceholderDescription(mindbodyDesc)) return mindbodyDesc;
  ...
  function extractDurationFromName(name) {
    const match2 = name.match(/\((\d+)\s*(?:mins?|minutes?)\)/i);
  ...
  function ServiceList({ onSelectService }) {
    ...
    const groupedServices = reactExports.useMemo(() => {
      if (!services || services.length === 0) return [];
      const groups = /* @__PURE__ */ new Map();
      const baseUrl = config.apiUrl.replace("/functions/v1", "").replace("/functions", "");
      const getAbsoluteUrl = (path) => path.startsWith("http") ? path : `${baseUrl.replace(/\/$/, "")}${path}`;
      for (const service of services) {
        ...
        const category = categoryOverrides[canonicalName] || programNameOverrides[rawCategory] || (rawCategory.startsWith("Sauna Suite") ? "Private Suites" : rawCategory);
        if (category === "General") continue;
        if (hiddenGroupNames.has(canonicalName)) continue;
        const image = getAbsoluteUrl(
          serviceImages[canonicalName] || categoryImages[service.programName] || categoryImages[service.category] || categoryImages["default"]
        );
    ...
    const servicesByCategory = reactExports.useMemo(() => {
      const categoryMap = /* @__PURE__ */ new Map();
      let filtered = groupedServices;
      if (searchQuery.trim()) {
        const query = searchQuery.toLowerCase().trim();
        filtered = filtered.filter(
          (service) => service.baseName.toLowerCase().includes(query) || service.description.toLowerCase().includes(query)
        );
      }
      if (config.category) {
        filtered = filtered.filter(
          (service) => {
            var _a;
            return service.category.toLowerCase() === ((_a = config.category) == null ? void 0 : _a.toLowerCase());
          }
        );
      }
    ...
    if (isLoading) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 p-4", children: [...Array(3)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-32 bg-[hsl(25,10%,15%)] rounded animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[100px] w-[100px] bg-[hsl(25,10%,15%)] rounded-xl animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[100px] w-[100px] bg-[hsl(25,10%,15%)] rounded-xl animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[100px] w-[100px] bg-[hsl(25,10%,15%)] rounded-xl animate-pulse" })
        ] })
      ] }, i)) });
    ...
    if (error) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[hsl(35,8%,55%)] mb-4", children: "Unable to load services." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[hsl(35,8%,55%)]", children: "Please try again later." })
      ] });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 z-10 bg-[hsl(25,18%,12%)] py-3 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4", children: servicesByCategory.size === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[hsl(35,8%,55%)]", children: searchQuery.trim() ? "No services match your search." : "No services available." }) }) : Array.from(servicesByCategory.entries()).map(([category, categoryServices], index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CategorySection,
        {
          category,
  ...
  function BookingCalendar({ selectedDate, onSelect, availableDates }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[hsl(25,12%,12%)]/50 border border-[hsl(25,10%,20%)] rounded-xl p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "15 18 9 12 15 6" }) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-[hsl(35,15%,88%)]", children: format(currentMonth, "MMMM yyyy") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setCurrentMonth((prev) => addMonths(prev, 1)),
            className: "p-2 rounded-lg hover:bg-[hsl(25,10%,15%)] transition-colors text-[hsl(35,15%,88%)]",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "9 18 15 12 9 6" }) })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-1 mb-2", children: weekDays.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-xs font-medium text-[hsl(35,8%,55%)] py-2", children: day }, day)) }),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `
                ...
                ${isSelected ? "bg-[hsl(35,15%,75%)] text-[hsl(25,8%,8%)]" : isTodayDate ? "bg-[hsl(25,10%,15%)] text-[hsl(35,15%,88%)]" : ""}
                ${!isAvailable ? "text-[hsl(35,8%,35%)] cursor-not-allowed" : "text-[hsl(35,15%,88%)] hover:bg-[hsl(25,10%,15%)] cursor-pointer"}
  ...
  function TimeSlotPicker({ slots, selectedSlot, onSelect, isLoading }) {
    if (isLoading) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    if (slots.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[hsl(35,8%,55%)]", children: "No available times for this date." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[hsl(35,8%,45%)] mt-1", children: "Please try another date." })
      ] });
    }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: Object.entries(slotsByStaff).map(([staffName, staffSlots]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-[hsl(35,8%,55%)] mb-2", children: staffName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: staffSlots.map((slot) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `
                    ...
                    ${isSelected ? "bg-[hsl(35,15%,75%)] text-[hsl(25,8%,8%)]" : "bg-[hsl(25,10%,15%)] text-[hsl(35,15%,88%)] hover:bg-[hsl(25,12%,18%)] border border-[hsl(25,10%,20%)]"}
                  `,
            children: time
          },
          slot.id
  ...
  function BookingModal({ service, onClose }) {
    ...
    const [step, setStep] = reactExports.useState(hasVariants ? "variant" : "date");
    ...
    const [isLoadingSlots, setIsLoadingSlots] = reactExports.useState(false);
    const [isBooking, setIsBooking] = reactExports.useState(false);
    const [error, setError] = reactExports.useState(null);
    const client = reactExports.useMemo(() => createApiClient(config.apiUrl), [config.apiUrl]);
    reactExports.useEffect(() => {
    ...
    const displayPrice = (selectedVariant == null ? void 0 : selectedVariant.price) ? `£${selectedVariant.price.toFixed(2)}` : "Contact for pricing";
    const displayDuration = (selectedVariant == null ? void 0 : selectedVariant.duration) ? `${selectedVariant.duration} min` : "";
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[hsl(25,18%,12%)] rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border-b border-[hsl(25,10%,20%)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleBack,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-[hsl(35,15%,88%)]", children: step === "success" ? "Booking Confirmed" : `Book ${service.baseName}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: onClose,
            className: "p-2 rounded-lg hover:bg-[hsl(25,10%,15%)] transition-colors text-[hsl(35,15%,88%)]",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4", children: [
        step === "variant" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-[hsl(35,8%,55%)] mb-4", children: "Select Treatment Type" }),
          service.variants.map((variant) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
        ...
        step === "date" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-[hsl(35,8%,55%)] mb-4", children: "Select a Date" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            BookingCalendar,
            {
              selectedDate,
        ...
        step === "time" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-medium text-[hsl(35,8%,55%)] mb-4", children: [
            "Select a Time — ",
        ...
        step === "confirm" && selectedSlot && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-[hsl(35,8%,55%)] mb-4", children: "Confirm Booking" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[hsl(25,12%,15%)] rounded-xl p-4 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-medium text-[hsl(35,15%,88%)]", children: (selectedVariant == null ? void 0 : selectedVariant.name) || service.baseName }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-[hsl(35,8%,55%)] flex items-center gap-2", children: [
                  displayDuration && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: displayDuration }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-[hsl(35,15%,88%)]", children: displayPrice })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[hsl(25,10%,20%)] pt-3 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm text-[hsl(35,15%,88%)]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "h-4 w-4 text-[hsl(35,8%,55%)]", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
              ...
              selectedSlot.staffName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm text-[hsl(35,15%,88%)]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "h-4 w-4 text-[hsl(35,8%,55%)]", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
        ...
        step === "success" && selectedSlot && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6 py-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-[hsl(35,15%,88%)]", children: "Booking Confirmed!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[hsl(35,8%,55%)] mt-1", children: "Your appointment has been booked successfully." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[hsl(25,12%,15%)] rounded-xl p-4 text-left space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm text-[hsl(35,15%,88%)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "h-4 w-4 text-[hsl(35,8%,55%)]", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "16", y1: "2", x2: "16", y2: "6" }),
  ...
  function Widget({ config }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetProvider, { config, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceList, { onSelectService: handleSelectService }),
          selectedService && config.showBooking && /* @__PURE__ */ jsxRuntimeExports.jsx(
            BookingModal,
            {
  ...
  class RebaseServicesWidget2 extends HTMLElement {
    ...
    render() {
      ...
      this.root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(Widget, { config }));
    }
  }
  if (!customElements.get("rebase-services")) {
    customElements.define("rebase-services", RebaseServicesWidget2);
  }
  exports.RebaseServicesWidget = RebaseServicesWidget2;
