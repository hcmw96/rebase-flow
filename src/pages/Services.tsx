...
const Services = () => {
        ...
        Object.entries(groupedCategories).forEach(([categoryName, variants], index) => {
          if (variants.length > 0) {
            ...
            allServices.push({
              ...
              sessionId: variants[0].sessionId,
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Services Header */}
      <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8 bg-gradient-dark">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light text-white mb-6 tracking-wide">
            OUR SERVICES
          </h1>
          <p className="text-white/70 text-lg max-w-3xl mx-auto">
            Discover our range of wellness and recovery services designed to help you feel your best.
          </p>
        </div>
      </section>
