    ...
    <Dialog open={true} onOpenChange={onCancel}>
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4 mt-2">
          ...
          <Input placeholder="Nome no cartão" value={billingName} onChange={(e) => setBillingName(e.target.value)} />
          <Input placeholder="Número do cartão" value={creditCardNumber} onChange={(e) => setCreditCardNumber(e.target.value)} />
          ...
          <Input placeholder="Código postal" value={billingPostalCode} onChange={(e) => setBillingPostalCode(e.target.value)} />
        </div>
