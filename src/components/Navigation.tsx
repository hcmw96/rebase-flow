...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-filter backdrop-blur-16 bg-white/8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 glass-card rounded-b-2xl border-white/10">
        ...
        {isOpen && (
          <div>
            <div className="px-2 pt-2 pb-3 space-y-1 border-t border-white/20 bg-black rounded-t-lg">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  to={item.href}
